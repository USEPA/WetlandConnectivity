...
final$DomFlowCode[final$DomFlow=='Overland'] = 1
final$DomFlowCode[final$DomFlow=='Riparian'] = 2
master_table$DomFlow = final$DomFlow[match(master_table$COMID, final$COMID)]
master_table$DomFlowCode = final$DomFlowCode[match(master_table$COMID, final$COMID)]
...
rmNA = na.omit(master_table)
write.csv(rmNA, file = paste0(cat_path, 'DomDrainClass_narm.csv'), row.names=F)
```
