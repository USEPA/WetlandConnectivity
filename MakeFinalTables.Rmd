...
Wetland_regions = readOGR('L:/Priv/CORFiles/Geospatial_Library/Data/Project/WetlandConnectivity/SpatialDataInputs/Tiner Region Boundaries','TinerWetlandGroups')
...
for (k in 1:length(tables)){
  ...
  saveRDS(result, file = paste0('L:/Priv/CORFiles/Geospatial_Library/Data/Project/WetlandConnectivity/SpatialDataInputs/Wetlands_NLCD',year,'/FinalTables/',tables[k],'.rds'))
...
library(stringr)
wetland_zonal_path = paste0('L:/Priv/CORFiles/Geospatial_Library/Data/Project/WetlandConnectivity/SpatialDataInputs/Wetlands_NLCD',year,'/WetlandOnlyZonal')
table_path = paste0('L:/Priv/CORFiles/Geospatial_Library/Data/Project/WetlandConnectivity/SpatialDataInputs/Wetlands_NLCD',year,'/FinalTables/WetlandTables/')
...
# Recode and update type, freq, imp, class
...
fullwetlands$Mag <- ifelse(fullwetlands$Type=="Riparian", "VF",
  ifelse(fullwetlands$Type=="Overland", ifelse(fullwetlands$MagOv<=24, "VF", ifelse(fullwetlands$MagOv/24<=14, "FA", "MO")),
  ifelse(fullwetlands$MagSh<=1, "VF", ifelse(fullwetlands$MagSh<=14, "FA", ifelse(fullwetlands$MagSh/365.25<=1, "MO", ifelse(fullwetlands$MagSh/365.25<=10, "SL", "VS"))))))
fullwetlands$Freq <- ifelse(fullwetlands$FreqPa==0, "L", ifelse(fullwetlands$FreqPa==0.5, "M", "H"))
fullwetlands$Imp <- ifelse(fullwetlands$Type=="Riparian", ifelse(rowSums(fullwetlands[,c("ImpDrImperv","ImpDrAg")])==0, "N",
