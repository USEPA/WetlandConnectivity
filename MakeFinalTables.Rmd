...
#BasinAreaSqKm_
tmp = readRDS(paste0(rds_path, 'BasinAreaSqKm_.rds'))[c('WET_ID', 'CatAreaSqKm', 'AreaSqKm')]
...
#DrainClass_
tmp = readRDS(paste0(rds_path, 'DrainClass_.rds'))[c('WET_ID', 'DomDrainClass')]
nrow(tmp); length(unique(tmp$WET_ID))
...
# I'm dropping CatAreaSqKm - it's the same as DrainAreaSqKm (mhw)
...
library(stringr)
wetland_zonal_path = 'L:/Priv/CORFiles/Geospatial_Library/Data/Project/WetlandConnectivity/SpatialDataInputs/Wetlands_NLCD2011/WetlandOnlyZonal'
...
### Combine final tables for wetland type percent variables into once table and merge with final combined wetland results
```{r, eval=F}
library(plyr)
rds_path = paste0('L:/Priv/CORFiles/Geospatial_Library/Data/Project/WetlandConnectivity/SpatialDataInputs/Wetlands_NLCD',year,'/FinalTables/')
