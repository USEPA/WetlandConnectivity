...
rpu_lookup_path = paste0('L:/Priv/CORFiles/Geospatial_Library_Projects/WetlandConnectivity/SpatialDataInputs/Wetlands_NLCD',year,'b/WetlandPath/LookupTables/')
...
for(i in 1:length(rpus)){
  ...
  if(i == 1){
    ...
    tester = rbind(tester, in_table)
  }
  
  test <- tester[duplicated(tester$WET_ID), ]
  test <- test[order(test$WET_ID), ]
  tail(test, n=300)
  
  tester[tester$WET_ID == 1, ]
