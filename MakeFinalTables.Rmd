...
Flow Class
=======
#Add COMID, eco9, and Riparian to FlowClass tables
>>>>>>> 9952881348808efa8529b4a837f5ba616e678696
```{r}
accum_path = 'L:/Priv/CORFiles/Geospatial_Library/Data/Project/WetlandConnectivity/SpatialDataInputs/Wetlands_NLCD2011/WetlandPath/Accumulation/'
...
<<<<<<< HEAD
  ...
  test = merge(in_table, allwet, by.x='PATHID', by.y='STRMLNK_ID')
  
  nrow(in_table)
  write.csv(intable, paste0(out_path, 'FlowClass_', rpus[i], '.csv'), row.names=F)
