...
for(i in 1:length(rpus)){
  ...
  in_table = in_table[ , c('WET_ID', 'PATHID','COMID','CatAreaSqKm','WSA_9', 'STATE','WetlandRegion', 'Riparian', 'Shallow', 'ShallowDeep', 'Overland', 'DomFlow')]
  summary(in_table)
...
for(i in 1:length(rpus)){
  ...
  in_table = in_table[ , c('BASINID', 'PATHID','COMID','CatAreaSqKm','WSA_9', 'STATE','WetlandRegion', 'Riparian','PRECIP_2YR24HR_MM', 'slope', 'Manning', 'run', 't_overland')]
...
for(i in 1:length(rpus)){
  ...
  allwet$WetlandRegion <- comeco$WetlandRegion[match(allwet$WET_ID, comeco$WetID)]
  in_table = merge(in_table, allwet, by.x='PATHID', by.y='STRMLNK_ID',all.y=T)  
  in_table = in_table[ , c('WET_ID', 'PATHID','COMID','CatAreaSqKm','WSA_9', 'STATE','WetlandRegion', 'Riparian', 'run', 'slope', 'porosity_max', 'perm_min', 't_shallow')]
...
for(i in 1:length(rpus)){
  ...
  in_table = in_table[ , c('WET_ID','PATHID','COMID','CatAreaSqKm','WSA_9', 'STATE','WetlandRegion', 'Riparian','BasinImperv')]
  in_table$Riparian[in_table$Riparian==1] = 100
  print(summary(in_table))
...
for(i in 1:length(rpus)){
  ...
  names(in_table)[1] = 'WET_ID'
  names(in_table)[3] = 'PATHID'
  in_table = in_table[ , c('WET_ID','PATHID','COMID','CatAreaSqKm','WSA_9', 'STATE','WetlandRegion', 'Riparian','PctAgDrainBasin')]
  in_table$Riparian[in_table$Riparian==1] = 100
  print(summary(in_table))
...
for(i in 1:length(rpus)){
  ...
  in_table = merge(in_table, allwet, by.x='PATHID', by.y='STRMLNK_ID',all.y=T)  
  in_table = in_table[ , c('WET_ID','PATHID','COMID','CatAreaSqKm','WSA_9', 'STATE','WetlandRegion', 'Riparian','PctAgDrainPath')]
...
for(i in 1:length(rpus)){
  ...
  in_table = read.csv(paste0(table_path, 'RunoffFreq_', rpus[i], '.csv'))
  ...
  in_table = in_table[ , c('WET_ID','PATHID','COMID','CatAreaSqKm','WSA_9', 'STATE','WetlandRegion', 'Riparian','DomFldFreqCls')]
  in_table$Riparian[in_table$Riparian==1] = 100
  print(summary(in_table))
  write.csv(in_table, paste0(table_path, 'RunoffFreq_', rpus[i], '.csv'), row.names=F)
  }
```
...
for(i in 1:length(rpus)){
  ...
  in_table = in_table[ , c('WET_ID','PATHID','COMID','CatAreaSqKm','WSA_9', 'STATE','WetlandRegion', 'Riparian','DomDrainClass')]
  in_table$Riparian[in_table$Riparian==1] = 100
  print(summary(in_table))
...
for(i in 1:length(rpus)){
  ...
  in_table = in_table[ , c('WET_ID','PATHID','COMID','CatAreaSqKm','WSA_9', 'STATE','WetlandRegion', 'Riparian','LeveeInfluence')]
...
for(i in 1:length(rpus)){
  ...
  names(in_table)[1] = 'WET_ID'
  names(in_table)[3] = 'PATHID'
  in_table = in_table[ , c('WET_ID','PATHID','COMID','CatAreaSqKm','WSA_9', 'STATE','WetlandRegion', 'Riparian','AreaSqKm')]
  in_table$Riparian[in_table$Riparian==1] = 100
...
for(i in 1:length(rpus)){
  ...
  in_table = in_table[ , c('WET_ID','PATHID','COMID','CatAreaSqKm','WSA_9', 'STATE','WetlandRegion', 'Riparian','CanalInfluence')]
  in_table$Riparian[in_table$Riparian==1] = 100
...
# Wetland_regions = readOGR('L:/Priv/CORFiles/Geospatial_Library/Data/Project/WetlandConnectivity/SpatialDataInputs/Tiner Region Boundaries','FocalRegions_Tiner_Texas')
...
#            'FlowClass_', 'Imperviousness_', 'LeveeInfluence_', 'OverlandFlow_', 'RunoffFreq_', 'ShallowFlow_', 'WetBasinArea_')
# 
...
# comeco_path = paste0('L:/Priv/CORFiles/Geospatial_Library/Data/Project/WetlandConnectivity/SpatialDataInputs/Wetlands_NLCD',year,'/LookupTables/')
# 
# tables = c('BasinAreaSqKm_', 'CanalInfluence_', 'RunoffFreq_')
# 
# for(k in 1:length(tables)){
#   for(i in 1:length(rpus)){
#     
...
for(i in 1:length(rpus)){
  ...
  names(in_table) = c('WET_ID', 'PATHID', 'COMID', 'WSA_9', 'STATE', 'WetlandRegion', 'Riparian', 'BasinAreaSqKm', 'WetlandAreaSqKm')
  write.csv(in_table, paste0(table_path, 'BasinAreaSqKm_', rpus[i], '.csv'), row.names=F)
}
...
tables = c('AgDrainage_Basin_', 'AgDrainage_Path_', 'BasinAreaSqKm_', 'CanalInfluence_', 'DrainClass_',
           'FlowClass_', 'Imperviousness_', 'LeveeInfluence_', 'OverlandFlow_', 'RunoffFreq_', 'ShallowFlow_')
