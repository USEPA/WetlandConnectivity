...
eco9_sp = readOGR('L:/Priv/ARM Data/Omernik_Ecoregions_And_Aggregated_Ecoregions','Aggr_Ecoregions9_2015')
...
for(i in 1:length(rpus)){
  ...
  intable$PRECIP_2YR24HR_MM[is.na(in_table$PATHID)] = 0
  intable$slope[is.na(in_table$PATHID)] = 0
  intable$Manning[is.na(in_table$PATHID)] = 0
  intable$Riparian = 100; xwet$run = 0
  xwet$t_overland = 0
