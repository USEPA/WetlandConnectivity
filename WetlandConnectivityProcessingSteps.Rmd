...
#            cat = NHDDir + "/NHDPlus" + regions + "/NHDPlus" + hydro + "/NHDPlusCatchment/cat"
                ...
                if not arcpy.Exists(FullStreamsDir + '/FullStreams_' + subdirs.split('Null',2)[1] + '.tif'):
                    ...
                    RgnGrp = gdal.Open(FullStreamsDir + '/RegionGroup_' + hydro + '.tif')
                    ...
                    FullStreams = Con(newRaster == 1, 1) #run it through a process to get it to be integer and in native ESRI format (exclude odd NUMPY stuff)                
                    FullStreams.save('%s/FullStreams_%s.tif'%(working_dir,subdirs.split('Null',2)[1]))
```
