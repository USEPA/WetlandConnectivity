...
out_dir = 'L:/Priv/CORFiles/Geospatial_Library/Data/Project/WetlandConnectivity/SpatialDataInputs/Wetlands_NLCD'+year+'/AllWetlands_rpu2/'
...
# FullStreams.py
# 11/28/2016
# Description: Create full stream lines for NA wetland processing
# By: Marc Weber
# ---------------------------------------------------------------------------
...
#                arcpy.env.mask = fdr 
            ...
            # gridded flowlines from NHDPlus don't need to be year specific, just the NLCD add-on to gridded flowlines
            flowgrid = 'L:/Priv/CORFiles/Geospatial_Library/Data/Project/StreamCat/LandscapeRasters/QAComplete/WaterMask/Mosaics/flowgrid' + hydro
            if not arcpy.Exists(flowgrid):
                ...
                RegionGroup = FullStreamsDir + '/RegionGroup_' + hydro + '.tif'
                if not arcpy.Exists(FullStreamsDir + '/RegionGroup_' + hydro + '.tif'):
