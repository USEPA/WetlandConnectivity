...
for (i in 1:59){
  ...
  #Adjust for correct wetland - path association - we no longer need to do this adjustment (mweber 3/31/17)
  ...
  # Get area from wetland catchments - no longer need to do this (mweber 3/31/17)
  ...
  Riparian <- AllWetlands[is.na(AllWetlands$STRMLNK_ID),]
