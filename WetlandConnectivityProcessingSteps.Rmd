    ...
    for hydro in inputs[region]:
        ...
        for dirs in os.listdir(nhddir + "/NHDPlus%s/NHDPlus%s"%(region, hydro)):
            if dirs.count("FdrFac") and not dirs.count('.txt') and not dirs.count('.7z'):
                ...
                #wetcon.save(working_dir + '/ScratchDir/wetcon.tif')
                ...
                newraster = array2raster(working_dir + '/ScratchDir/isoWetlands_' + rpu + '.tif', wetland_ras, z)
                newRaster = Raster(working_dir + '/ScratchDir/isoWetlands_' + rpu + '.tif')
                ...
                newRaster3 = Con(newRaster != 0, newRaster2)
