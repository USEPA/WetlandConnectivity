...
for i in range(len(hydroregions)):
    ...
    if not arcpy.Exists(paths_dir + '/CostPath' + rpu +'.tif'):
        ...
        if not arcpy.Exists(working_dir + '/scratch2/hydrodems.gdb/hydrodem'+ rpu):
            #Read in hydrodem 
...
#            arcpy.gp.RasterCalculator_sa('Float(\"' + working_dir + '/scratch2/hydrodem'+ rpu +'.tif\")', 
#                                         working_dir + '/scratch2/hydrodems.gdb/hydrodem'+ rpu)

            #Run cost path tool (the devil) for each wetland outlet adjusted hydrodem and backlink (i.e., flow direction) rasters
