...
### Create numpy files for accumulation catchment results
```{r, engine='python', engine.path='C:/Python27/ArcGIS10.3/python.exe', eval=F}
...
for file in files:
    ...
    np.save(numpy_dir + 'bastards/downPath' + rpu + '.npy', a)
    ...
    np.save(numpy_dir + 'children/downPath' + rpu + '.npy', a)
