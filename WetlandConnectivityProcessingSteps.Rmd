...
year = '2011'
wetlands_dir = working_dir + '/Wetlands_NLCD' + year +'b/AllWetlands/'
out_dir = working_dir + '/Wetlands_NLCD' + year +'b/AllWetlands_rpu/'
...
from WetCat_functions import children, bastards, dbf2DF
...
wetlands_dir = working_dir + '/Wetlands_NLCD'+ year +'b/AllWetlands_rpu'
streams_dir = working_dir + '/Wetlands_NLCD'+ year +'b/FullStreams'
fromto_dir = working_dir + '/Wetlands_NLCD' + year + 'b/WetlandPath/FlowTables'
...
for i in range(len(hydroregions)):
    ...
    streamlink_ras = read_raster(path_dir + '/StreamLink_' + rpu + '.tif')[5]
    ...
    stream = read_raster(streams_dir + '/FullStreams_' + rpu + '.tif')
    ...
    WetlandsNoPath = outdf[outdf['Riparian'] == 1]
    WetlandsWithPath = outdf[outdf['Riparian'] == 0]
    #write out csv files, including riparian and non-riparian files
    outdf.to_csv(lookup_dir + '/AllWetlands_StreamLink_Lookup_' + rpu + '.csv', index=False)
    WetlandsNoPath.to_csv(lookup_dir + '/WetlandsNoPath_StreamLink_Lookup_' + rpu + '.csv', index=False)
    WetlandsWithPath.to_csv(lookup_dir + '/WetlandsWithPath_StreamLink_Lookup_' + rpu + '.csv', index=False)
```
