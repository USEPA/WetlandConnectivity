...
A good example of where a wetland catchment is never build is something like this wetland on an island in a stream - this is within area of what we define as 'FDR Null' and can't build a watershed for this
